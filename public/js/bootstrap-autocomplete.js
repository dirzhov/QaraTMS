...
(function (global, factory) {
    ...
    var DefaultType = {
        ...
        filterAjaxParams: '(null|object)',
        labelKey: '(null|string)',
        itemRenderer: '(null|function)',
        maxResult: 'number',
    ...
    var Autocomplete = /*#__PURE__*/function () {
            ...
            this._timer = setTimeout(function () {
                ...
                $.ajax(_objectSpread({}, {
                    ...
                    success:function (res) {
                        ...
                        if (res)
                        res.forEach(function (i) {
                            if (_this3._config.labelKey) {
                                var val = i[_this3._config.labelKey].toLowerCase();
                                if (!_this3._items.includes(val))
                                    _this3._items.push(val);

                                _this3._labels[val] = i[_this3._config.labelKey];
                                local.push(i);

                                _this3._result.push(i);
                            } else { // will be rendered as array of strings by default
                                var val = i.toLowerCase();
                                if (!_this3._items.includes(val))
                                    _this3._items.push(val);
                ...
                }, _this3._config.filterAjaxParams));
        ...
        _proto._renderItem = function _renderItem(items) {
            ...
            items.forEach(function (i) {
                ...
                var item = null;
                if (_this6._config.itemRenderer) {
                    item = _this6._config.itemRenderer(_this6._dropdown, i);
                } else {
